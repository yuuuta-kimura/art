...
<div class="row" style="text-align: center; background-color:#FFFFFF;">
	...
	<div class="swiper-container">
		...
		<div class="swiper-wrapper">
			<!-- Slides -->
			<div class="swiper-slide"><img src="<?php bloginfo( 'template_directory' );?>/img/slide1.png"></div>
			<div class="swiper-slide"><img src="<?php bloginfo( 'template_directory' );?>/img/slide2.png"></div>
			<div class="swiper-slide"><img src="<?php bloginfo( 'template_directory' );?>/img/slide3.png"></div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	<div id="top_prof">
		...
		<div id="top_prof_text">
			<div id="top_prof_name">ayaka nakamura</div>
			<div id="top_prof_detail">
				<p>
				手描きをメインに、繊細かつ力強い画面づくりを目指し、<br>
				アーティストのミュージックビデオやアートワーク、テレビ番組のアニメーション、装丁のイラストなどを手がける。<br>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <div id="top_detail">
		...
		$response = file_get_contents('http://e-art.tokyo/user/getgallery.php?artist_id=1&limit=6&apikey=');
	...
	<a href="http://e-art.tokyo/user/gallery.php?artist_id=1" target="_blank">
