...
$kiyaku = file_get_contents('kiyaku_artist.txt').PHP_EOL.PHP_EOL;
$kiyaku= $kiyaku.file_get_contents('../user/kiyaku_privacy.txt').PHP_EOL.PHP_EOL;
$kiyaku= $kiyaku.file_get_contents('../user/kiyaku_torihiki.txt');
